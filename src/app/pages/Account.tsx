                ...
                <div className="mx-4 mt-8 flex max-w-[600px] flex-grow flex-col gap-y-4">
                    <div className="flex flex-col gap-4 xsm:flex-row">
                        ...
                        >
                            ...
                            <p className="text-3xl font-bold text-pink-200/90">[product] user</p>
                        </Container>
                        <a
                    ...
                    >
                        ...
                        <div className="px-4">
                            <div>
                                ...
                                <p className="mb-3 text-lg font-bold">[username]</p>
                            </div>
                            <div>
                                <p className="text-xs font-medium text-neutral-400">
                                    Email address
                                </p>
                                <p className="mb-3 text-lg font-bold">[email_address]</p>
                            </div>
                            <div>
                                <p className="text-xs font-medium text-neutral-400">Display name</p>
                                <p className="mb-3 text-lg font-bold">[display_name]</p>
                            </div>
                            <div>
